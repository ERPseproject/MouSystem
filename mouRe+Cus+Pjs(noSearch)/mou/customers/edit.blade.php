...
<head>
    <title>แก้ไขข้อมูลผู้รับบริการ</title>
    <meta charset="utf-8">
                ...
                <div class="col-sm-8">
                  <div class="w3-row w3-padding-64">
                    <div class="w3-twothird w3-container">
                      ...
                      <form method="post" action="{{action('MouController@update', $id)}}" onSubmit="JavaScript:return fncSubmit();">
                        {{csrf_field()}}
                      <h1 class="w3-text-teal">แก้ไขข้อมูลผู้รับบริการ</h1>
                      <div class="form-group">
                        <label >ชื่อผู้รับบริการ:</label>
                        <input name="name" type="text" class="form-control" id="name" value="{{$customers->name}}">
                      </div>
                      <div class="form-group">
                        <label for=>ที่อยู่:</label>
                        <input name="address" type="text" class="form-control" id="address" value="{{$customers->address}}">
                      </div>

                      <div class="form-group">
                        <label >เลขประจำตัวผู้เสียภาษี:</label>
                        <input name="tax_id" type="text" class="form-control" onKeyPress="CheckNum()" id="tax" value="{{$customers->tax_id}}">
                      </div>

                      <div class="form-group">
                        <label >สถานภาพ:</label>
                        <select class="form-control" name="status" value="{{$customers->status}}">
                      ...
                      <a href="{{url('/mou/customer/show')}}" class="btn btn-danger">ยกเลิก</a> <input type="submit" value="อัพเดท" class="btn btn-default">
                      <!-- hidden method สำหรับ edit -->
