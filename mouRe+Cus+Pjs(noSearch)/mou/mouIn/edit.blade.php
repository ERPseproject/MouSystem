                ...
                <div class="col-sm-8">
                  <div class="w3-row w3-padding-64">
                    <div class="w3-twothird w3-container">
                      <h1 class="w3-text-teal">แก้ไขข้อมูลโครงการพัฒนาวิชาการ</h1>
                      <div class="form-group">

                      <form method="post" action="{{action('PjsController@update', $id)}}" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();">
                      {{ csrf_field() }}

                      
                        <label >ชื่อโครงการ:</label>
                        <input type="text" class="form-control" name="name" id="name" value="{{$pjs->name}}">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="proid" id="proid" value="{{$pjs->proid}}">
                      </div>
                      ...
                      <div class="form-group" id='b'>
                        ...
                        <input type="text" class="form-control" name="budget" onKeyPress="CheckNum()" id="budget" value="{{$pjs->budget}}">
                      </div>
                      ...
                      <form class="form-inline">
                        <div class="form-group" id='d'>
                          ...
                          <input type="text" id="datepicker" name="opend" value="{{ $pjs->opend ? date('d/m/Y', strtotime($pjs->opend))  : null }}">&nbsp;&nbsp;
                        </div>
                        <div class="form-group" id='g'>
                          <label id='f'>วันปิดโครงการ:</label>
                          
                          <input type="text" id="datepicker2" name="closed" value="{{ $pjs->closed ? date('d/m/Y', strtotime($pjs->closed)) : null }}">&nbsp;
                        </div>
                     
                      <div class="form-group" id='e'>
                        <label>ปีงบประมาณ:</label>
                        <input type="text" class="form-control" name="year"  id='year' onKeyPress="CheckNum()" value="{{$pjs->year}}">
                    
                      </div>

                      <input type="submit" class="form-control-btn"> <a href="{{url('/mou/mouIn/showmin')}}" class="btn btn-danger"> ยกเลิก</a>
