          ...
          if(!allowedExtensions.exec(filePath)){
              ...
              if (fileInput.files && fileInput.files[0]) {
                  ...
                  reader.onload = function(e) {
                      document.getElementById('imagePreview').innerHTML = '<img style="height: 400px; width: 400px;" src="'+e.target.result+'"/>';
                  };
                  ...
                  <div class="w3-row w3-padding-40">
                    <div class="w3-twothird w3-container">
                      ...
                      <div class="form-group">
                         ...
                         <form method="post" action="{{ route('addimage') }}" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();">
                        {{csrf_field()}}
                        ...
                        <?php
                          echo App\Http\Controllers\RecipeController::getPid(); 
                        ?>
                    ...
                    <b>อัพโหลดใบเสร็จ:</b>
                      ...
                      <div class="form-group" id='b' style="display:none;">
                        ...
                        <option >-</option>
                          <?php
                          echo App\Http\Controllers\RecipeController::getCus(); 
                         
                        ?>
                        </select>
                      </div>
                      
                      <a href="{{url('/recipe/show')}}" class="btn btn-success">ดูข้อมูลการบันทึกใบเสร็จ</a> <input type="submit" value="ยืนยัน" class="btn btn-default">
                      </form>
