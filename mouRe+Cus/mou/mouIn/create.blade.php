...
<head>
    ...
    function fncSubmit()
    {
      ...
      else if(document.getElementById('type').vaule  == "MOU" )
      {
                  ...
                  <div class="w3-row w3-padding-64">
                    <div class="w3-twothird w3-container">
                      ...
                      <!-- ต้องดึงจากก HR ทั้ง 4 อัน-->
                        ...
                        <?php
                          echo App\Http\Controllers\PjsController::getHR(); 
                        ?>
                      ...
                      <div class="form-group" id='a'>
                        ...
                        <option>-</option>
                        <?php
                          echo App\Http\Controllers\PjsController::getCus(); 
                        ?>
                        </select>
                      </div>
                      ...
                      <b>อัพโหลดไฟล์เอกสาร:</b>
                        <input type="file" name="fname" id="file"><br>
                      ...
                      <form class="form-inline">
                        ...
                        <div class="form-group">
                          <label id='g'>วันปิดโครงการ:</label>
